        ...
        <div class="card card-primary">
            ...
            <form id="form" data-parsley-validate="" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="color" value="{{$color->color}}" required="" placeholder="Enter color here">
...
(function($){
    $('#form').on('submit', function(evt){
        ...
        if($('#form').parsley().isValid()) {
            ...
            $.ajax({
                url: "{{route('admin.color.post.create')}}",
                method: "POST",
                data: form,
                processData: false,
                contentType: false,
                success: function(response){
                    Swal.fire({
                        ...
                        window.location.href = "{{route('admin.color.listing')}}";
                    });
                },
                error: function(jqXHR, jqStatus, jqThrown){
                    ...
                    if (status === 422) {
                        ...
                        $('.error__cont').html(`<li class="-red">${errors.color[0]}</li>`);
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
